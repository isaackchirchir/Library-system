...
<html lang = "eng">
	...
	<body style = "background-color:#d3d3d3;">
		<nav class = "navbar navbar-default navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/anu.png" width = "50px" height = "50px" />
					<h4 style="color:red;" class = "navbar-text navbar-right">GRACE ROLES LIBRARY</h4>
				</div>
			</div>
		</nav>
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				<div class = "container-fluid">
					<img src = "images/chirchir.png" width = "100px" height = "100px"/>
					<br />
					<br />
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-th"></i> Transaction</a>
						...
						<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-file"></i> Reports</a>
						<ul style = "list-style-type:none;">
							<li><a href = "student_report.php" style = "font-size:15px;"><i class = "glyphicon glyphicon-print"></i> Student</a></li>
							<li><a href = "book_report.php" style = "font-size:15px;"><i class = "glyphicon glyphicon-print"></i> Books</a></li>
						</ul>
					</li>
					<li><a  style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-cog"></i> Switch</a>
						<ul style = "list-style-type:none;">
		...
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-right">Afica Nazarene University &copy; All rights reserved 2019</label>
			</div>
		</nav>
	</body>
