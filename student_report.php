			...
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-th"></i> Transaction</a>
						...
						<ul style = "list-style-type:none;">
							<li><a href = "student_pdf.php" style = "font-size:15px;"><i class = "glyphicon glyphicon-print"></i> Student</a></li>
							<li><a href = "generate pdf.php" style = "font-size:15px;"><i class = "glyphicon glyphicon-print"></i> Books</a></li>
						</ul>
					</li>
