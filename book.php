...
<html lang = "eng">
	...
	<body style = "background-color:#d3d3d3;">
			...
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-th"></i> Transaction</a>
						...
						<ul style = "list-style-type:none;">
							<li><a href = "borrowing.php" style = "font-size:15px;"><i class = "glyphicon glyphicon-print"></i> Student</a></li>
		...
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-right">Africa Nazarene University &copy; All rights reserved 2019</label>
			</div>
		</nav>
	</body>
